...
RobotomyRequestForm::RobotomyRequestForm() : AForm("Roboto", 72, 45), _target("Default"){
    std::cout << "New Roboto form was created " << std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(std::string target) : AForm("Roboto", 72, 45), _target(target){
    std::cout << "New Roboto form was created " << std::endl;
}

RobotomyRequestForm::RobotomyRequestForm(RobotomyRequestForm const &copy) : AForm("Roboto_copy", 72, 45){
    *this = copy;
    std::cout << "New Roboto form was created by copie " << std::endl;
}

RobotomyRequestForm::~RobotomyRequestForm(){
    std::cout << "Roboto form was destroyed " << std::endl;
}
